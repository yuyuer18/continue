      ...
      <div className="relative">
        ...
        <ListboxOptions className="min-w-32 max-w-48">
          ...
          <ListboxOption value="plan" className={"gap-1"}>
            <div className="flex flex-row items-center gap-1.5">
              <ModeIcon mode="plan" />
              <span className="">计划 Plan</span>
              <ToolTip
                style={{
                  zIndex: 200001,
                }}
                content="文件只读和MCP工具可用"
              >
          ...
          >
            <div className="flex flex-row items-center gap-1.5">
              ...
              <span className="">后台模式</span>
              <ToolTip
                style={{
                  zIndex: 200001,
                }}
                content={"后台模式不能与本地代理一起使用."}
              >
                <InformationCircleIcon className="h-2.5 w-2.5 flex-shrink-0" />
              </ToolTip>
            </div>
